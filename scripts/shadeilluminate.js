    ...
    Render() {
        ...
        for (let i = 0; i < this.scene.models.length; i++) {
			if(this.algorithm==='gouraud'&&this.scene.models[i].shader === 'color'){
				...
				//this.gl.uniform3fv(this.shader[this.algorithm+"_"+this.scene.models[i].shader].uniform.light_col, this.scene.light.point_lights.color);
				//this.gl.uniform3fv(this.shader[this.algorithm+"_"+this.scene.models[i].shader].uniform.light_pos, this.scene.light.point_lights.position);
				...
				//this.gl.uniform3fv(this.shader['gouraud_texture'].uniform.light_col, this.scene.light.point_lights[0].color); // modify needed
				...
				this.gl.uniform2fv(this.shader['gouraud_texture'].uniform.tex_scale, this.scene.models[i].texture.scale);
				
				this.gl.activeTexture(this.gl.TEXTURE0);
				this.gl.bindTexture(this.gl.TEXTURE_2D, this.scene.models[i].texture.id);
				this.gl.uniform1i(this.shader['gouraud_texture'].uniform.image, 0);
				
			}else if (this.algorithm==='phong'&&this.scene.models[i].shader === 'texture'){
				this.gl.useProgram(this.shader['phong_texture'].program);
				glMatrix.mat4.identity(this.model_matrix);
				glMatrix.mat4.translate(this.model_matrix, this.model_matrix, this.scene.models[i].center);
				glMatrix.mat4.scale(this.model_matrix, this.model_matrix, this.scene.models[i].size);
				
				this.gl.uniform3fv(this.shader['phong_texture'].uniform.material_col, this.scene.models[i].material.color);
				this.gl.uniformMatrix4fv(this.shader['phong_texture'].uniform.projection, false, this.projection_matrix);
				this.gl.uniformMatrix4fv(this.shader['phong_texture'].uniform.view, false, this.view_matrix);
				this.gl.uniformMatrix4fv(this.shader['phong_texture'].uniform.model, false, this.model_matrix);
				this.gl.uniform3fv(this.shader['phong_texture'].uniform.light_ambient, this.scene.light.ambient);
				
				//this.gl.uniform3fv(this.shader['phong_texture'].uniform.light_col, this.scene.light.point_lights.color);
				//this.gl.uniform3fv(this.shader['phong_texture'].uniform.light_pos, this.scene.light.point_lights.position);
				
				this.gl.uniform1f(this.shader['phong_texture'].uniform.shininess, this.scene.models[i].material.shininess);
				this.gl.uniform3fv(this.shader['phong_texture'].uniform.camera_pos, this.scene.camera.position);
				
				this.gl.uniform2fv(this.shader['phong_texture'].uniform.tex_scale, this.scene.models[i].texture.scale);
				
				this.gl.activeTexture(this.gl.TEXTURE0);
				this.gl.bindTexture(this.gl.TEXTURE_2D, this.scene.models[i].texture.id);
				this.gl.uniform1i(this.shader['phong_texture'].uniform.image, 0);
			}
